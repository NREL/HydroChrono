...
Invoke-Expression -Command "gnuplot plot_sphere_decay.plt"
...
Set-Location $BUILD_DIR\demos\results
Invoke-Expression -Command "gnuplot plot_rm3_decay.plt"
...
Set-Location $BUILD_DIR\demos\results
Invoke-Expression -Command "gnuplot F3OF_DT1_SURGE.plt"
...
Set-Location $BUILD_DIR\demos\results
Invoke-Expression -Command "gnuplot F3OF_DT2_PITCH.plt"
...
# Copy-Item "$ROOT_DIR\demos\f3of\reference_data" -Destination "$BUILD_DIR\demos\results"
Set-Location $BUILD_DIR\demos\results
Invoke-Expression -Command "gnuplot F3OF_DT3_PITCH.plt"
